...
function printLog(content, type) {
  ...
  switch (type) {
    case LogLevelMap.tip: {
      ...
      console.log(color.cyan(`[WebProxy Log][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.system_error: {
      ...
      console.error(color.red(`[WebProxy ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.rule_error: {
      ...
      console.error(color.red(`[WebProxy RULE_ERROR][${timeString}]: ` + content));
      break;
    }
    ...
    case LogLevelMap.warn: {
      ...
      console.error(color.yellow(`[WebProxy WARN][${timeString}]: ` + content));
      break;
    }
